 ...
 *
 * Return: Number of history entries read from
 * the file on success, 0 otherwise.
 */
 ...
 * from the file on success, 0 otherwise.
 */
...
/**
 * renumber_history - Renumbers the history of the
